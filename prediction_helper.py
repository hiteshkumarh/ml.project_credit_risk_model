...
def prepare_df(age, income, loan_amount, loan_tenure_months,num_open_accounts,
...
def predict(age, income, loan_amount, loan_tenure_months,num_open_accounts,
            avg_dpd_per_delinquency, delinquency_ratio, credit_utilization_ratio,
            residence_type, loan_purpose, loan_type):

    input_df = prepare_df(age, income, loan_amount, loan_tenure_months,num_open_accounts,
            avg_dpd_per_delinquency, delinquency_ratio, credit_utilization_ratio,
            residence_type, loan_purpose, loan_type);
...
def calculate_credit_score(input_df,base_score=300,scale_length=600):
    ...
    x = np.clip(x, -500, 500)  # optional safeguard
